                ...
                <div className="signup__hero">
                    <div className="container">
                        <div className="row justify-content-center">
                            <div className="col-md-4 signup__form ">
                                ...
                                <div className="signup__form--bottom pt-4">
                                    <div className="mb-2">
                                        <span>New to Netflix?</span> <b>Sign up now.</b>
                                    </div>
                                    <p className="signup__form--text">This page is protected by Google reCAPTCHA to ensure you're not a bot. <a href='/'>Learn more.</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
